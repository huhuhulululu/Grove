...
export const zhCN: Catalog = {
  ...
  'ui.panel.quests': '任务',
  'ui.panel.buffs': '增益',
  'ui.panel.incursion': '地牢突袭',
  'ui.incursion.dashboard_line': '第 {floor}/{floors} 层 · HP {hp} · 探险进行中',
  'ui.incursion.dashboard_cleared': '已抵达全部 {floors} 层 · HP {hp} · 逃出以收入战利品',
  'ui.panel.economy': '经济',
  'ui.panel.loadout': '构筑',
  ...
  'cli.help.cmd.status': '  status [--json]\n      显示当前 Grove 游戏状态。\n      --json  将计算后的游戏状态导出为 JSON 到 stdout（便于 jq 处理）',
